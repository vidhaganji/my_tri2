      ...
      fetch("http://127.0.0.1:8086/api/users/authenticate", requestOptions)
          .then(response => {
            if (response.ok) {
                ...
                window.location.href = "https://parkib.github.io/pb2csp/2024/01/30/login-copy.html"
              } else {
  ...
  <form action="javascript:login_user()">
    ...
    <p>
     <button class="button-spacing">Log In</button>
          <button onClick = "window.location.href ='https://parkib.github.io/pb2csp//2024/01/30/signup_page_demographics.html'" class="button-spacing" >Sign Up</button>
    </p>
  </form>
